...
namespace newLive
{
    public class Bear: Omnivorous<IEdibleForBear>,IEdibleForHuman, IEdibleForWolf,
         IEdibleForLion, IExtractionForMan
    {
        public Bear(int x, int y, Random random, Map map, int number, GenderUnit.Gender unitGender)
        ...
        {
            return new Bear(CurrentCoordinate.X, CurrentCoordinate.Y,
